...
* **Workspace Root**: `<USER_DESKTOP>\00_ZENTRALE_INSEL`
* **Core Folders**:
  * `00_START_HIER/`
...
* **Reference Texts**: 16 files successfully extracted to `<USER_PROFILE>\.gemini\antigravity-ide\scratch\extracted_text\`.
