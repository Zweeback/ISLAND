...
def main() -> None:
    ...
    tmp_dir = Path(
        "c:/Users/derzw/Desktop/00_ZENTRALE_INSEL/08_TOOLS_SCRIPTS/blast_agent/.tmp")
    ...
    print(
        f"Successfully compiled local inventory scan to {out_file.as_posix()}", file=sys.stderr)
