...
class TestLocalIndexerShouldExcludeFile:
    ...
    def test_should_exclude_file_returns_true_for_excluded_patterns(self, indexer, file_name):
    ...
    def test_should_exclude_file_returns_false_for_normal_files(self, indexer, file_name):
